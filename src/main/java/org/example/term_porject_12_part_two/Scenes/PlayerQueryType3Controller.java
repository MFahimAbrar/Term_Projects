...
public class PlayerQueryType3Controller {
    ...
    @FXML
    private ListView<Player> PlayerQueryType3Results;

    @FXML
    private TextField PositionInput;

    @FXML
    private Text PostionField;
    ...
    void onSubmitClick(ActionEvent event) {
        ...
        if(flag) {str1 = PositionInput.getText(); return;}
    ...
    private void updatePlayerQueryResults() throws IOException, ClassNotFoundException{
        socketWrapper.write("playerposition="+str1);
        ...
        if (true) {
            ...
            PlayerQueryType3Results.setItems(playerList);

            // Set custom cell factory
            PlayerQueryType3Results.setCellFactory(param -> new ListCell<>() {
                @Override
