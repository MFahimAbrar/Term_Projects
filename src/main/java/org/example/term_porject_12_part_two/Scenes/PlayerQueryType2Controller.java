...
public class PlayerQueryType2Controller {
    ...
    @FXML
    private ListView<Player> PlayerQueryType2Results;
    ...
    void onSubmitClick(ActionEvent event) {
        ...
        if(flag) {str1 = CountryInput.getText(); str2 = ClubInput.getText(); return;}
        if(CountryInput.getText().isEmpty() || ClubInput.getText().isEmpty()){
            AlertUtil.showErrorAlert("Input Error", "Empty Input Provided", "Please try again with proper input");
            return;
        }
        str1 = CountryInput.getText(); str2 = ClubInput.getText();
    ...
    private void updatePlayerQueryResults() throws IOException, ClassNotFoundException{
        socketWrapper.write("playercountryclub="+str1+"="+str2);
        ...
        if (true) {
            ...
            PlayerQueryType2Results.setItems(playerList);

            // Set custom cell factory
            PlayerQueryType2Results.setCellFactory(param -> new ListCell<>() {
                @Override
                protected void updateItem(Player player, boolean empty) {
                    ...
                    if (empty || player == null) {
                        ...
                        positionText.setWrappingWidth(150);
